...
!function(t, e) {
    ...
    function Oe(t) {
        return ke(t, "wheel", Be),
        this
    }
    function Ie(t) {
        return S(t, "mousedown touchstart dblclick contextmenu", Be),
    ...
    var mt = {
      ...
      , B = it.extend({
        ...
        _limitCenter: function(t, e, i) {
            ...
            (o = this._getBoundsOffset(o, i, e)).round().equals([0, 0])) ? t : this.unproject(n.add(o), e)
        },
    ...
    O.extend({
        ...
        addTo: function(t) {
            return O.prototype.addTo.call(this, t),
    ...
    var Ai = o.extend({
        ...
        initialize: function(t, e) {
            t && (t instanceof L.LatLng || d(t)) ? (this._latlng = w(t),
            c(this, e)) : (c(this, t),
            this._source = e),
    ...
    Ai.extend({
        ...
        _adjustPan: function(t) {
            ...
            (a || h) && e.fire("autopanstart").panBy([a, h], {
    ...
    Ai.extend({
      ...
      , Ii = (B.include({
        openTooltip: function(t, e, i) {
            return this._initOverlay(Oi, t, e, i).openOn(this),
            this
        },
    ...
    var _t = n.extend({
      ...
      , Ct = (B.addInitHook("addHandler", "boxZoom", _t),
    B.mergeOptions({
        doubleClickZoom: !0
    }),
    n.extend({
      ...
      , Zt = (B.addInitHook("addHandler", "doubleClickZoom", Ct),
    B.mergeOptions({
        dragging: !0,
        inertia: !0,
    ...
    n.extend({
      ...
      , St = (B.addInitHook("addHandler", "dragging", Zt),
    B.mergeOptions({
        keyboard: !0,
        keyboardPanDelta: 80
    }),
    n.extend({
      ...
      , Et = (B.addInitHook("addHandler", "keyboard", St),
    B.mergeOptions({
        scrollWheelZoom: !0,
    ...
    n.extend({
      ...
      , kt = (B.addInitHook("addHandler", "scrollWheelZoom", Et),
    B.mergeOptions({
    ...
    n.extend({
        ...
        _onDown: function(t) {
            ...
            this._holdTimeout = setTimeout(a(function() {
                this._cancel(),
                this._isTapValid() && (S(document, "touchend", A),
      ...
      , At = (B.addInitHook("addHandler", "tapHold", kt),
    B.mergeOptions({
        touchZoom: b.touch,
    ...
    n.extend({
      ...
      , Yi = (B.addInitHook("addHandler", "touchZoom", At),
    B.BoxZoom = _t,
